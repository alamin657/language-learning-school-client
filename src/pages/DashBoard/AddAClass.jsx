        ...
        fetch(img_hosting_url, {
            ...
            .then(imgResponse => {
                if (imgResponse.success) {
                    ...
                    const { name, instructor, email, price, seats, enrolled } = data;
                    const addClass = { name, status: 'pending', enrolled, instructor, email, price: parseFloat(price), seats: parseFloat(seats), image: imgURL }
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                        <div className="flex gap-2">
                            <div className="form-control">
                                ...
                                <input type="text" defaultValue={user?.displayName} {...register("name", { required: true })} name='name' placeholder="Instructor Name" className="input input-bordered" />
                            </div>
                        ...
                        <div className="form-control">
                            ...
                            <input type="text" defaultValue={user?.photoURL} readOnly {...register("picture", { required: true })} name='picture' placeholder="image" className="input input-bordered" />
                        </div>
                        ...
                        <div className='flex gap-2'>
                            ...
                            <div className="form-control">
                                ...
                                <input type="email" defaultValue={user?.email} readOnly {...register("email", { required: true })} placeholder="Instructor Email" className="input input-bordered" />
                            </div>
                        </div>
                        <div className='flex gap-2'>
                            <div className="form-control">
